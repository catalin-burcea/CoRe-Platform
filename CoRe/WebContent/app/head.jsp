...
<style type="text/css"> <%@ include file="assets/css/my-css.css" %> </style>
...
<script src="//cdnjs.cloudflare.com/ajax/libs/ace/1.1.3/mode-diff.js" type="text/javascript" charset="utf-8"></script>

<link rel="stylesheet" href="//code.jquery.com/ui/1.10.4/themes/smoothness/jquery-ui.css">
<script src="//code.jquery.com/ui/1.10.4/jquery-ui.js"></script>
<script type="text/javascript">
	<%@ include file="assets/js/loglevel.min.js" %>
</script>